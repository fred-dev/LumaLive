...
#define		IDLE_COLOR		ofColor::fireBrick
#define		OVER_COLOR		ofColor::white
#define		DOWN_COLOR		ofColor::burlyWood


class interactiveImageObject : public ofxMSAInteractiveObject {
public:
    ofImage objectImage;
    int pageNumber;
    string path;
    ...
    void loadImage(ofPixels pixels){
        objectImage.setFromPixels(pixels);
    }
    void loadImage(string path){
        objectImage.loadImage(path);
    }
